...
export default function DetteStrategie({ dettes=[] }) {
  ...
  return (
     <div style={{width:"100%",boxSizing:"border-box"}}>
      ...
      {/* Tableau */}
      <div style={{borderRadius:12,overflow:"hidden",border:"1px solid rgba(255,255,255,0.08)",width:"100%"}}>
        <div style={{display:"grid",gridTemplateColumns:"minmax(0,2fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr)",gap:0,background:"rgba(255,255,255,0.04)",padding:"8px 14px",borderBottom:"1px solid rgba(255,255,255,0.07)"}}>
        ...
        {rows.map((r,i)=>(
          <div key={i}>
            <div style={{display:"grid",gridTemplateColumns:"minmax(0,2fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr)",gap:0,padding:"12px 14px",background:i%2===0?"rgba(255,255,255,0.015)":"transparent",borderBottom:i<rows.length-1?"1px solid rgba(255,255,255,0.05)":"none",alignItems:"center"}}>
        ...
        {/* Ligne totale */}
        <div style={{display:"grid",gridTemplateColumns:"minmax(0,2fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr) minmax(0,1fr)",gap:0,padding:"12px 14px",background:"rgba(201,160,99,0.05)",borderTop:"1px solid rgba(201,160,99,0.15)",alignItems:"center"}}>
