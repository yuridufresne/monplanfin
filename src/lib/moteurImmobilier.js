...
function calculerPrimeSCHL(montantPret, prix) {
  ...
  else return -1; // mise insuffisante
...
export function calculerQualification(p) {
  ...
  const celiappMaxTheorique = p.enCouple ? 80000 : 40000; // 40k × 2
  ...
  return {
    ...
    opportunites: {
      ...
      conseilsDettes: dettesTotal > 1500, // dettes lourdes = recommander remboursement
    },
  };
}