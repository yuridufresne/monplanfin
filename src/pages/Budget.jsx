              ...
              <>
                <ResponsiveContainer width="100%" height={200}>
                  <PieChart>
                    ...
                    <Tooltip formatter={(v) => fmt(v)} contentStyle={{ background: "rgba(10,15,30,0.4)", backdropFilter: "blur(16px)", border: "1px solid rgba(255,255,255,0.2)", borderRadius: 12, color: "#ffffff", fontSize: 12, fontWeight: 600 }} />
                  </PieChart>
                </ResponsiveContainer>
