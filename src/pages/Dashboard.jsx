...
export default function Dashboard() {
  ...
  // ── NIF calculé depuis les profils ABF (source unique : lib/calcNIF.js) ─────
  const nifResult = useMemo(() => calcNIFFromProfiles(profiles), [profiles]);
  const nifCible = nifResult.capitalNIF;
