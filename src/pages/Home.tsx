    ...
    <div style={{ background: "#050810", minHeight: "100vh", position: "relative", overflow: "hidden" }}>
      ...
      <section style={{ position: "relative", maxWidth: 1180, margin: "0 auto", padding: "30px 24px 80px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(270px, 1fr))", gap: 22 }}>
          {[["01", "Répondez simplement", "Une conversation guidée de 10 minutes — vos revenus, vos rêves, vos inquiétudes. Sauvegarde automatique, reprenez quand vous voulez."], ["02", "Voyez votre portrait", "Valeur nette, indépendance financière, protections : tout se calcule en direct, en langage humain. Aucun jargon."], ["03", "Passez à l’action", "Recevez un plan concret. Et si vous le souhaitez, un conseiller partenaire inscrit à l'AMF prend le relais — gratuitement."]].map(([n2, titre, texte]) => (
